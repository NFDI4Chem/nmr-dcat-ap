# Contributing to nmr-dcat-ap

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
nmr-dcat-ap. These guidelines are not strict rules.
...
The nmr-dcat-ap team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the nmr-dcat-ap technical leads
...
[issues]: https://github.com/NFDI4Chem/nmr-dcat-ap/issues/
[pulls]: https://github.com/NFDI4Chem/nmr-dcat-ap/pulls/
