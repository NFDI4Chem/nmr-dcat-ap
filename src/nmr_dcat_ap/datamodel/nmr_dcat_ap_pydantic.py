...
linkml_meta = LinkMLMeta({'default_prefix': 'nmr_dcat_ap',
     'default_range': 'string',
     'description': 'This is a DCAT Application Profile extension that formalizes '
                    'the NFDI4Chem Minimum information about chemical '
                    'investigation stAndard foR reportinG liquid-stAte nmR '
                    'experImenTs of smAll moleculeS (MARGARITAS).',
     'id': 'https://NFDI4Chem.github.io/nmr-dcat-ap/nmr_dcat_ap.yaml',
     'imports': ['linkml:types', 'chemdcatap:dcat_4c_ap'],
     'license': 'CC-BY 4.0',
     'name': 'nmr-dcat-ap',
     'prefixes': {'AFE': {'prefix_prefix': 'AFE',
                  ...
                  'nmr_dcat_ap': {'prefix_prefix': 'nmr_dcat_ap',
                                  'prefix_reference': 'https://NFDI4Chem.github.io/nmr-dcat-ap/nmr_dcat_ap.yaml#'},
     ...
     'see_also': ['https://NFDI4Chem.github.io/nmr-dcat-ap'],
     'source_file': 'src/nmr_dcat_ap/schema/nmr_dcat_ap.yaml',
     'title': 'nmr-dcat-ap'} )
...
class Materialistic(ConfiguredBaseModel):
    ...
    has_temperature: Optional[list[Temperature]] = Field(default=None, description="""The slot to provide the Temperature of a MaterialEntity.""", json_schema_extra = { "linkml_meta": {'alias': 'has_temperature',
         'domain_of': ['Materialistic', 'ChemicalReaction'],
